...
const StepTextbox = ({children}) => <p
    className={'max-w-full text-left w-[560px] bg-stone-50 px-8 py-6 z-10 shadow-md opacity-90 mb-16'}>{children}</p>

export const Steps = [
    {
        content: <>
            <StepTextbox>In autumn 2007, the Sejm (large chamber of the Polish parliament) decided to dissolve itself.
            ...
            <StepTextbox>When the PiS took over the government again in 2015, confidence continued to rise.
    ...
    {
        content: <>
            <StepTextbox>Other countries in Eastern Europe such as <b>Hungary</b>, the <b>Czech
    ...
    {
        content: <>
            <StepTextbox>At the other end of the scale, we meet <b>Switzerland</b>. The Swiss have also improved their
                score
    ...
    {
        content: <>
            <StepTextbox>Alongside the Swiss Confederation, <b>Norway</b> and <b>Luxembourg</b> are the frontrunners
                when it comes to
    ...
    {
        content: <>
            <StepTextbox>In the years 2006 - 2022, the inhabitants of a total of <b>41 countries</b> were asked: <b>Do
                you trust
            ...
            <StepTextbox>The OECD considers this "<i>an <b>important indicator</b> to measure how people perceive the quality of, and
                how they associate with, government institutions in democratic countries</i>".</StepTextbox>
        </>,
        chartProps: {
